...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TimelineClipInfo&&(identical(other.id, id) || other.id == id)&&(identical(other.startFrame, startFrame) || other.startFrame == startFrame)&&(identical(other.durationFrames, durationFrames) || other.durationFrames == durationFrames));
}


@override
int get hashCode => Object.hash(runtimeType,id,startFrame,durationFrames);

@override
String toString() {
  return 'TimelineClipInfo(id: $id, startFrame: $startFrame, durationFrames: $durationFrames)';
}
