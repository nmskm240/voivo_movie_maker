...
/// @nodoc
mixin _$TimelineInfo {

 List<TimelineTrackInfo> get tracks;
/// Create a copy of TimelineInfo
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$TimelineInfoCopyWith<TimelineInfo> get copyWith => _$TimelineInfoCopyWithImpl<TimelineInfo>(this as TimelineInfo, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TimelineInfo&&const DeepCollectionEquality().equals(other.tracks, tracks));
}
...
@override
String toString() {
  return 'TimelineInfo(tracks: $tracks)';
}
...
/// @nodoc
abstract mixin class $TimelineInfoCopyWith<$Res>  {
  factory $TimelineInfoCopyWith(TimelineInfo value, $Res Function(TimelineInfo) _then) = _$TimelineInfoCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$TimelineInfoCopyWithImpl<$Res>
    implements $TimelineInfoCopyWith<$Res> {
  _$TimelineInfoCopyWithImpl(this._self, this._then);

  final TimelineInfo _self;
  final $Res Function(TimelineInfo) _then;
...
/// Adds pattern-matching-related methods to [TimelineInfo].
extension TimelineInfoPatterns on TimelineInfo {
...
@override List<TimelineTrackInfo> get tracks {
